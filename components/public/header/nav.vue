  ...
  <div class="m-nav">
    <ul class="nav">
      <li class="list">
        ...
        <dl>
          <dd><nuxt-link to="to">我的订单</nuxt-link></dd>
          <dd><nuxt-link to="to">我的收藏</nuxt-link></dd>
          <dd><nuxt-link to="to">抵用券</nuxt-link></dd>
          <dd><nuxt-link to="to">账户设置</nuxt-link></dd>
        </dl>
      </li>
      <li class="">
      ...
      <li class="list bd">
        <nuxt-link to="/centent">商家中心</nuxt-link>
        <dl>
          ...
          <dd><nuxt-link to="">美团排队合作</nuxt-link></dd>
        </dl>
      </li>
      <li class="list site">
        <nuxt-link to="/to">网站导航</nuxt-link>
